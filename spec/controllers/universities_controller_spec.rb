...
describe UniversitiesController do
  ...
  let(:valid_attributes) { { "uname" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved university as @university" do
        ...
        post :create, {:university => { "uname" => "invalid value" }}, valid_session
        assigns(:university).should be_a_new(University)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested university" do
        ...
        University.any_instance.should_receive(:update).with({ "uname" => "MyString" })
        put :update, {:id => university.to_param, :university => { "uname" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the university as @university" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        University.any_instance.stub(:save).and_return(false)
        put :update, {:id => university.to_param, :university => { "uname" => "invalid value" }}, valid_session
        assigns(:university).should eq(university)
      end
